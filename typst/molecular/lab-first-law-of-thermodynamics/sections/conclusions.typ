...
#pagebreak()
== Вывод 2
В рамках лабораторного работы был проведён эксперимент по измерению удельной теплоёмкости алюминия. Методология основывалась на преобразовании механической работы в тепловую энергию с помощью трения. В ходе работы фиксировались изменения температуры в зависимости от приложенной работы. На основе полученных данных рассчитано экспериментальное значение теплоёмкости, а также проведено сравнение с теоретической величиной.
