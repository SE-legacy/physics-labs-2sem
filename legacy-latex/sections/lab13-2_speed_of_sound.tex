\textbf{Цель:} Измерение скорости звука в воздухе методом стоячей волны.
...
\begin{enumerate}
    ...
    \item{Данные прямых измерений и вычислений занести в следующую таблицу(\ref{tab:Laba_13_2}):}
\end{enumerate}
